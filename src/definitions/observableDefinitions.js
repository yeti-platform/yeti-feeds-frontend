export const OBSERVABLE_TYPES = [
  ...
  },
  {
    ...
    fields: [
      { field: "value", type: "text", label: "Value", displayList: true, editable: true },
      { field: "tags", type: "list", label: "tags", displayList: true, editable: false },
      { field: "created", type: "datetime", label: "Created", displayList: true, editable: true },
      ...
      { field: "is_privileged", type: "bool", label: "Priviledged", displayList: false, editable: true },
      {
        field: "can_escalate_privs",
        type: "bool",
        label: "Can escalate priviledge",
        displayList: false,
        editable: true
      },
      { field: "is_disabled", type: "bool", label: "Disabled", displayList: false, editable: true },
      { field: "account_created", type: "datetime", label: "Created on", displayList: false, editable: true },
      { field: "account_expires", type: "datetime", label: "Expires on", displayList: false, editable: true },
      {
